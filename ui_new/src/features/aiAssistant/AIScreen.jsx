...
// Scripted synthetic preview response. Replace with a real API only after product/runtime validation.
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      <div style={{ flex: 1, overflow: 'auto', padding, display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div style={{ padding: '10px 14px', borderRadius: 12, border: '1px solid rgba(180,76,255,0.18)', background: 'rgba(180,76,255,0.06)', color: 'var(--muted2)', fontSize: 12.5, lineHeight: 1.5 }}>
          <strong style={{ color: 'var(--purple)' }}>Synthetic AI preview.</strong> This screen uses scripted sample responses only. No live AI call is made, and no real engineering data should be entered.
        </div>
