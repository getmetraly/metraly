...
var seedTemplates = []*domain.DashboardTemplate{
	{
		...
		Icon:        "home",
		Category:    "Leadership",
		Widgets:     sandboxDashboards[0].Widgets,
		Layout:      sandboxDashboards[0].Layout,
	},
	{
		ID:          "cto",
		Name:        "CTO Dashboard",
		...
		Icon:        "trendingUp",
		Category:    "Leadership",
		Widgets:     sandboxDashboards[1].Widgets,
		Layout:      sandboxDashboards[1].Layout,
	},
	{
		ID:          "vp",
		...
		Icon:        "users",
		Category:    "Leadership",
		Widgets:     sandboxDashboards[2].Widgets,
		Layout:      sandboxDashboards[2].Layout,
	},
	{
		ID:          "tl",
		Name:        "Tech Lead Dashboard",
		Description: "CI health, PR queue, and sprint progress",
		Icon:        "gitPR",
		Category:    "Team",
		Widgets:     sandboxDashboards[3].Widgets,
		Layout:      sandboxDashboards[3].Layout,
	},
	{
		ID:          "devops",
		Name:        "DevOps Dashboard",
		Description: "Deploy frequency, MTTR, and incident tracking",
		Icon:        "cpu",
		Category:    "Operations",
		Widgets:     sandboxDashboards[4].Widgets,
		Layout:      sandboxDashboards[4].Layout,
	},
	{
		ID:          "ic",
		Name:        "My Dashboard",
		Description: "Personal PR, CI, and sprint view",
		Icon:        "activity",
		Category:    "Personal",
		Widgets:     sandboxDashboards[5].Widgets,
		Layout:      sandboxDashboards[5].Layout,
	},
}
